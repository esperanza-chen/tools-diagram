  ...
  <div :class="pageClass">
    ...
    <div id="designer">
      ...
      <div id="designer_viewport">
        ...
        <div 
          id="navigation_view" 
          class="dock_view dock_view_navigator" 
          style="display: block; top: unset; bottom: 60px;"
        >
          <div class="navigation_bounding">
            <div class="navigation_view_container">
              ...
              <div id="navigation_eye" style="display: block;"></div>
            </div>
          </div>
        </div>
          ...
          <div class="new_invitation_container" style="margin-bottom: 10px">
            <div style="padding: 4px 0px">
              ...
              <span id="add_prompt1" style="margin-left: 100px">
                ...
                <span>输入受邀请人姓名或者邮箱。</span>
              </span>
              <span id="add_prompt2" style="margin-left: 100px">
                <span class="badge">2</span>
                <span>从以下用户列表中选择一个用户发起邀请。</span>
              </span>
