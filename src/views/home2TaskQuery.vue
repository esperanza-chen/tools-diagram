<template>
  <div style="height: 100%">
    ...
    <div id="designer_header">
      <!-- <div class="titlebar">
        <a class="btn_back" href="/diagraming/back?id=62874ea8513b7190af124543" title="返回"
          ><span class="ico ico_goback"></span
        ></a>
        <div class="row row1">
          <div id="title_container">
            <span class="diagram_title">产品登录流程</span>
          </div>
        </div>
        <div class="row row2 menubar">
          <ul id="menu_bar">
            <li id="menu_bar_file" tit="menu_bar_file" menu="bar_list_file">文件</li>
            <li id="menu_bar_edit" tit="menu_bar_edit" menu="bar_list_edit">编辑</li>
            <li id="menu_bar_view" tit="menu_bar_view" menu="bar_list_view">视图</li>
            <li id="menu_bar_insert" tit="menu_bar_insert" menu="bar_list_insert">插入</li>
            <li id="menu_bar_page" tit="menu_bar_page" menu="bar_list_page">页面</li>
            <li id="menu_bar_arrange" tit="menu_bar_arrange" menu="bar_list_arrange">排列</li>
            <li id="menu_bar_help" tit="menu_bar_help" menu="bar_list_help">帮助</li>
          </ul>
          <div id="saving_tip"></div>
        </div>
        <div class="share_container">
          <div class="header_right_btn">
            <div class="toolbar_button active" id="export_btn" style="padding: 0px 10px;" menu="export_file">下载</div>
            ...
            <div
              id="share_btn"
              class="toolbar_button drop_button active"
              onmousedown="UI.showShareMenu(event)"
              style="display: none;"
            >
              分享
              <span class="icon_0323">&#xe99d;</span>
            </div>
            <div
              id="wemeet_share_btn"
              class="toolbar_button drop_button active"
              style="display: none; background: #4386f5ff; color: #ffffff;"
              onmousedown="UI.showShareMenu(event)"
            >
              分享
              <img
                class="mind-icons"
                src="assets/images/wemeet/wemeet_share_white.svg"
                style="width: 18px; height: 18px; padding: 2px 0;"
              />
            </div>
          </div>
        ...
        <div class="toolbar_con">
          ...
          <div class="toolbar_con_box">
            ...
            <div id="bar_font_family" title="字体" class="toolbar_button" style="width: 80px">
              <div class="text_content">Alibaba PuHuiTi Regular</div>
            ...
            <div id="bar_beginarrow" tit="bar_beginarrow" title="起点" class="toolbar_button drop_button">
              <div arrow="none" class="ico diagraming-icons">
                <svg class="icon-svg" aria-hidden="true"><use xlink:href="#iconwuduandian_huaban1_huaban1"></use></svg>
              </div>
            ...
            <div class="toolbar_devider"></div>
            <div id="bar_lock" tit="bar_lock" title="锁定 (Ctrl+L1)" class="toolbar_button">
              <div class="ico diagraming-icons">&#xe753;</div>
            </div>
      ...
      <div class="lanebar">
        <div class="lanebar_box" style="float: left; margin: 5px 20px">
          ...
          <div class="lanebar_tit" style="padding-top: 6px">泳道数量</div>
        </div>
    ...
    <div id="designer">
      ...
      <div id="designer_viewport">
        ...
        <div id="designer_layout" class="layout">
          <div id="canvas_container" style="background: #e1eaf7">
            <div id="designer_canvas">
              ...
              <title-popup
                ref="titlePop"
                :timeValueSet.sync="flowItemInfo.timeValue"
        ...
        <div v-show="showItem" id="showItem">
          <div class="showItem-box">
            <div class="showItem-close">
              <div class="showItem-close-right"><div>></div></div>
            </div>
            <div class="showItem-title">
              <div>工作内容</div>
            </div>
            <el-input
        ...
        <div id="dock">
          ...
          <div class="dock_buttons">
            <div
              id="dock_btn_navigator"
              tit="dock_btn_navigator"
              title="导航"
              disableTitle="true"
            ...
            <div
              id="dock_btn_attribute"
              tit="dock_btn_attribute"
              title="数据属性"
              disableTitle="true"
              class="toolbar_button"
              onclick="Dock.showView('attribute', true)"
            >
        ...
        <div class="dock_view dock_view_graphic">
          ...
          <div class="dock_content">
            ...
            <div
              id="dock_line_style"
              class="toolbar_button drop_button active btn_inline"
            ...
            <div class="fill_detail fill_detail_gradient">
              ...
              <div
                id="gradient_type"
                class="toolbar_button active btn_normal btn_inline"
        ...
        <div class="dock_view dock_view_page">
          ...
          <div class="dock_content">
            ...
            <div
              id="dock_page_size"
              class="toolbar_button active btn_inline"
            ...
            <div style="height: 10px; clear: both"></div>
            <input id="dock_page_showPrintLine" type="checkbox" /><label for="dock_page_showPrintLine"
              >显示打印分隔线</label
            >
            <div class="dock_devider"></div>
            ...
            <div>
              <div class="dock_watermark_box" id="dock_watermark_box">
                <div class="dock_content_title">
                  水印
                  <span class="diagraming-icons dock-member-icon"
                    ><img class="vip" src="images/icon/po_vip.svg"
                  /></span>
                  ...
                  <a
                    href="/upgrade"
                    id="dock_topic_sytip"
                    class="uplpad_file_tip hide"
                    target="_blank"
                    style="font-size: 12px"
                    onclick="poCollect('访问升级页面',{'功能':'流程图-添加水印'});buried_point_fn('setTouchPlace','水印_vip限免');"
                    >VIP限免</a
                  >
                </div>
        ...
        <div class="dock_view dock_view_attribute" style="width: 350px">
          ...
          <div class="dock_content" style="padding: 5px 0px 5px">
            <div class="attr_add">
              <div
                id="attr_add_btn"
                class="toolbar_button active noover"
            ...
            <div class="history_bar">
              ...
              <div id="area_history_add" class="area_history" style="margin-left: 7px">
                <textarea
                  ...
                  class="input_text"
                  placeholder="填写注释..."
                  style="width: 236px; height: 36px; margin-bottom: 5px"
                ></textarea>
                <div
                  class="toolbar_button active"
                  style="width: 70px; display: inline-block"
        ...
        <div class="content_box">
          <div class="footer_left">
            <div id="collaborators">
              <div class="colla-users-list"></div>
            </div>
          ...
          <ul class="footer_right">
            <li><a href="/support" target="_blank">帮助中心</a></li>
    ...
    <div id="ui_container">
      <ul id="arrange_align_list" class="menu list" style="display: none">
        <li cate="align_shape" al="left" original-title="左对齐"><div class="ico diagraming-icons">&#xe749;</div></li>
        <li cate="align_shape" al="center" original-title="居中对齐">
          <div class="ico diagraming-icons">&#xe74b;</div>
        </li>
        <li cate="align_shape" al="right" original-title="右对齐"><div class="ico diagraming-icons">&#xe74f;</div></li>
        <li cate="align_shape" al="top" original-title="顶端对齐"><div class="ico diagraming-icons">&#xe74e;</div></li>
      ...
      <ul id="font_list" class="menu list menu_ico" style="display: none">
        ...
        <li class="devider"></li>
        <li style="font-family: 'Alibaba PuHuiTi Regular'">Alibaba PuHuiTi Regular</li>
        <li style="font-family: 'Alibaba PuHuiTi Medium'">Alibaba PuHuiTi Medium</li>
        <li style="font-family: 'Alibaba PuHuiTi Bold'">Alibaba PuHuiTi Bold</li>
      </ul>
      ...
      <ul id="font_align_list" class="menu list" style="display: none">
        <li cate="textAlign" al="left" original-title="左对齐"><div class="ico diagraming-icons">&#xe735;</div></li>
        <li cate="textAlign" al="center" original-title="居中对齐"><div class="ico diagraming-icons">&#xe733;</div></li>
        <li cate="textAlign" al="right" original-title="右对齐"><div class="ico diagraming-icons">&#xe736;</div></li>
        <li cate="vAlign" al="top" original-title="顶端对齐"><div class="ico diagraming-icons">&#xe730;</div></li>
        <li cate="vAlign" al="middle" original-title="垂直居中对齐">
          <div class="ico diagraming-icons">&#xe732;</div>
        </li>
        <li cate="vAlign" al="bottom" original-title="底端对齐"><div class="ico diagraming-icons">&#xe731;</div></li>
      </ul>
      ...
      <ul id="line_type_list" class="menu list" style="display: none">
        <li tp="broken"><div type="broken" class="ico diagraming-icons">&#xe73d;</div></li>
        <li tp="curve"><div type="curve" class="ico diagraming-icons">&#xe73c;</div></li>
        <li tp="normal"><div type="normal" class="ico diagraming-icons">&#xe73b;</div></li>
      </ul>
      <ul id="beginarrow_list" class="menu list menu_ico" style="display: none">
        ...
        <li arrow="solidArrow"><div class="ico diagraming-icons">&#xe73f;</div></li>
        <li arrow="dashedArrow"><div class="ico diagraming-icons">&#xe740;</div></li>
        <li arrow="normal"><div class="ico diagraming-icons">&#xe741;</div></li>
        <li arrow="solidDiamond"><div class="ico diagraming-icons">&#xe73e;</div></li>
        <li arrow="dashedDiamond"><div class="ico diagraming-icons">&#xe742;</div></li>
        <li arrow="solidCircle"><div class="ico diagraming-icons">&#xe745;</div></li>
        <li arrow="dashedCircle"><div class="ico diagraming-icons">&#xe743;</div></li>
        <li arrow="cross"><div class="ico diagraming-icons">&#xe746;</div></li>
        <li arrow="asynch1"><div class="ico diagraming-icons">&#xe744;</div></li>
        <li arrow="asynch2"><div class="ico diagraming-icons">&#xe747;</div></li>
      </ul>
      <ul id="endarrow_list" class="menu list menu_ico" style="display: none">
        <li arrow="none">
          <div class="ico diagraming-icons">
            <svg class="icon-svg" aria-hidden="true"><use xlink:href="#iconwuduandian_huaban1_huaban1-copy"></use></svg>
          </div>
        </li>
        <li arrow="solidArrow"><div class="ico diagraming-icons">&#xe76a;</div></li>
        <li arrow="dashedArrow"><div class="ico diagraming-icons">&#xe769;</div></li>
      ...
      <div id="hotkey_list" class="dialog">
        ...
        <div class="dialog_content">
          <div class="hotkey_content">
            ...
            <span class="hotkey_line">
              <span class="hotkey">调整图形大小时按住Ctrl </span
      ...
      <div class="equation-list" style="display: none">
        ...
        <div style="padding: 16px 0 12px 16px; font-size: 12px; color: #000">
          更多方程式参见
          <a
            href="https://www.tw.wiiaa.top/baike-Help:%E6%95%B0%E5%AD%A6%E5%85%AC%E5%BC%8F"
            target="_blank"
            style="color: #4386f5"
            >帮助:数学公式</a
          >
      ...
      <div id="link_dialog" class="dialog" style="min-width: 500px">
        ...
        <div class="dialog_content" style="padding: 30px 20px; text-align: center">
          <b>链接到：</b
          ><input placeholder="processon.com" id="linkto_addr" type="text" class="input_text" style="width: 350px" />
        </div>
      ...
      <div
        id="svg_dialog"
        style="width: 100%; height: 100%; position: fixed; top: 0; left: 0; visibility: hidden"
      ></div>
            ...
            <li>
              <div>
                <input
                  type="checkbox"
                  class="cate_parent"
                  value="uml_common,uml_usecase,uml_sequence,uml_class,uml_stateactivity,uml_deployment,uml_component"
                />UML图
              </div>
            </li>
            <li class="child">
            ...
            <li>
              <div>
                <input
                  type="checkbox"
                  class="cate_parent"
                  value="andriod_devices,andriod_elements,andriod_controls,andriod_icons"
                />Android界面原型图
              </div>
            </li>
            <li class="child">
            ...
            <li class="disable">
              <div>
                <input
                  ...
                  disabled
                  class="cate_parent"
                  value="network,network_aliyun,network_tencentcloud,network_aws2019,network_aws,network_cisco,network_azure"
                />网络拓扑图
              </div>
            </li>
            <li class="child">
    ...
    <div>
      ...
      <span
        style="display: none"
        id="TencentCaptcha"
        data-appid="2046103261"
        data-cbfn="callback_public"
        class="pro-btn default pub-btn"
        >点击验证</span
      >
    </div>
    ...
    <form
      id="team_shape_form"
      method="POST"
      action="https://api.processon.com/openapi/diagrams"
      target="iframe_team_shape"
    ...
    <!-- <div class="onerootinfo" style="right: 220px" @click="exportInfo">导出页面数据</div>
    <div class="onerootinfo" @click="importInfo">导入页面数据</div>
    <div class="onerootinfo allinfo" @click="lockingInfo">锁定</div> -->
    <tree-box
      v-if="TreeBoxType"
      :switchShow="TreeBoxType"
      title="参与人员"
      width="900px"
      height="420px"
      ...
      :persondata="{
        hostItem: flowItemInfo.hostItem,
        executeItem: flowItemInfo.executeItem,
        permissionItem: flowItemInfo.permissionItem,
      }"
    ></tree-box>
    <message-box
      title="判断选择走向"
      :width="500 + (branchList.length - 2) * 205 + 'px'"
      height="275px"
      :switchShow="showBox"
      @sure="submitPoint"
      @cancel="showBox = false"
    >
      <div class="box-main" slot="message-main">
        <div
          class="box-main-item"
          @click="selectBranch(index)"
          :style="index < branchList.length - 1 ? 'margin-right:25px' : ''"
          v-for="(item, index) in branchList"
          :key="item.branchNum"
        >
          <div class="box-main-item-select">
            <div class="box-main-item-select-icon" v-if="branchSelect.indexOf(index) !== -1">
              <div class="box-main-item-select-icon-center"></div>
            </div>
          </div>
          <div class="box-main-item-name">{{ item.text }}</div>
        </div>
      </div>
    </message-box>
  </div>
...
export default {
  ...
  mounted() {
    onDiagramMessage(onDiagramMessage);
    ...
    Bus.$on('home2TaskQueryMsg', this.IfDesignerNone);
  ...
  methods: {
    ...
    makeNodeGrayFun(iframeMessage) {
      console.log(iframeMessage, 'kkkkkkkkkkkkkkkkkkk');
      TaskFlowDiagram.makeNodeGray([iframeMessage]);
    },
    controlls(event) {
      if (event.data.name == 'toshowItemTask') {
        if (this.showTaskItem?.lineColor) this.clearLineColor();
        this.canToGet = true;
        setTimeout(() => {
          this.canToGet = false;
        }, 600);
        ...
        setTimeout(() => {
          ...
          let showTaskItem = JSON.parse(event.data.item);
          this.showTaskItem = showTaskItem;
          this.showTaskItemId = showTaskItem.id;
          console.log(showTaskItem, 'showTaskItem.category');
          if (showTaskItem.category === 'flow' || showTaskItem.category === 'basic') {
            let height = document.getElementById(showTaskItem.id).clientHeight;
            let width = document.getElementById(showTaskItem.id).clientWidth;
            this.taskLeft = showTaskItem.props.x - 20;
            this.taskTop = showTaskItem.props.y - 25;
            this.taskHeight = height + 30;
            this.taskWidth = width + 430;
            this.itemWidth = width + 20;

            let left = this.taskLeft - (this.iframeWidth - this.taskWidth) / 2;
            let top = this.taskTop - (this.iframeHeight - this.taskHeight) / 2;
            document.getElementById('designer_layout').scrollTo(left, top);

            if (showTaskItem.name === 'decision') {
              let priProcessTaskId = null;
              let data = Utils.copy(Model.define);
              let mapData = Object.values(data.elements);
              for (let i = 0, length = mapData.length; i < length; i++) {
                if (mapData[i].name === 'linker' && mapData[i].to.id === this.showTaskItem.id) {
                  priProcessTaskId = mapData[i].from.id;
                }
              }
              window.parent.postMessage(
                {
                  iframeMessage: showTaskItem.id || '',
                  type: 'getTaskDetail',
                  name: 'decision',
                  priProcessTaskId: priProcessTaskId,
        ...
        this.memoryState = -1;
        if (this.canClose) {
          if (this.showTask === true && this.isUpdate) {
            console.log(this.flowItemInfo, 'fhwsdjkfgdsjh');
            let name = this.showTaskItem?.textBlock?.[0]?.text.replace(/<[^>]+>/g, '') || '';
            const info = this.flowItemInfo;
            const taskItemId = this.showTaskItemId;
            setTimeout(() => {
              console.log(this.canToGet, 'fghdsfgdhg');
              console.log(info, 'fhwsdjkfgdsjh');
              window.parent.postMessage(
                {
                  iframeMessage: info,
                  flowItemId: taskItemId,
                  name: name,
                  type: 'toSubmitItem',
                  index: this.$route.query?.index,
                  canToGet: this.canToGet,
                },
                '*',
              );
              this.canToGet = false;
        ...
        TaskFlowDiagram.makeNodeGray(event.data.childTaskDtos);
      } else if (event.data.type === 'toShowItem') {
        // Designer.unlockShapes()
        // console.log(event.data.iframeMessage,"fgdsgfds")
        // const info = Model.getShapeById(this.showTaskItemId)
        // info.lineStyle = {lineColor: '255,255,0'}
        // Model.update(info)

        // // Designer.setLineStyle({lineColor: 'red'})
        // return
        const dataJSON = Utils.copy(Model.define);
        const currentShape = dataJSON.elements[this.showTaskItem.id];
        // console.log(dataJSON.elements[this.showTaskItem.id], '当前图形数据')
        // console.log(Designer.config.scale, 'uuuuuuuuuuuuuuuuu')
        this.taskTop = currentShape.props.y * Designer.config.scale;
        this.taskLeft = currentShape.props.x * Designer.config.scale;
        this.itemWidth = currentShape.props.w * Designer.config.scale;
        // this.taskWidth = currentShape.props.w

        this.showTask = true;

        // const shape = Model.getShapeById(this.showTaskItem.id);
        // console.log(shape,'dsadadasdsa')
        // shape.locked = false;
        // let info = Utils.getSelected();
        // console.log(info[0],'fgdsgfds')
        // info[0].lineStyle.lineColor = '255,255,0';
        // Schema.initShapeFunctions(info[0]);
        // Model.updateMulti(info);

        this.showTaskItem.lineColor = dataJSON.elements[this.showTaskItem.id]?.lineStyle?.lineColor || '1';
        // 置灰
        //dataJSON.elements[this.showTaskItem.id].fillStyle.color = "190,196,204";
        // dataJSON.elements[this.showTaskItem.id].lineStyle.lineColor = "161,167,179";
        switch (event.data.iframeMessage.taskState) {
          case '1':
            dataJSON.elements[this.showTaskItem.id].lineStyle.lineColor = '216,101,54';
            break;
          case '2':
            dataJSON.elements[this.showTaskItem.id].lineStyle.lineColor = '216,36,0';
            break;
          case '3':
            dataJSON.elements[this.showTaskItem.id].lineStyle.lineColor = '29,145,73';
            break;
        }
        Designer.open(dataJSON);
        Designer.initialize.initCanvas();

        this.isUpdate = event.data.iframeMessage.isUpdate;
        let flowItemInfo = event.data.iframeMessage;
        this.selectFlowItemId = event.data.iframeMessage.processTaskId;
        if (flowItemInfo === null) {
          ...
          const flowChangeValue = {
            ...
            // timeValue: [flowItemInfo.startTime, flowItemInfo.endTime],
            // taskState: Number(flowItemInfo.taskState) || 1,
            // hostItem: event.data.iframeMessage.executes[0],
            // executeItem: event.data.iframeMessage.participants,
            // permissionItem: event.data.iframeMessage.viewpeoples,
          };

          // if (this.flowItemInfo.permissionItem.length === 1 && this.flowItemInfo.permissionItem[0].userId === '1')
          //   this.flowItemInfo.permissionItem = [];
          // if (this.flowItemInfo.hostItem && this.flowItemInfo.hostItem.id)
          //   this.flowItemInfo.person = this.flowItemInfo.executeItem.length + 1;
          // else this.flowItemInfo.person = this.flowItemInfo.executeItem.length;

          // let personInfoArr = [].concat(this.flowItemInfo.executeItem, this.flowItemInfo.hostItem);
          // // console.log(personInfoArr, '==================11111')
          // this.flowItemInfo.personInfo = personInfoArr.slice(0, 5);
          // this.flowItemInfo.otherInfo = personInfoArr.slice(5) || [];
          // const userNameArr = this.flowItemInfo.otherInfo.map((r) => r.userName).join(',');
          // this.flowItemInfo.userNameStr = userNameArr;
      ...
      } else if (event.data.type === 'changeSuccess') {
        console.log(this.stateNum);
        this.$set(this.flowItemInfo, 'taskState', this.stateNum);
        if (Number(this.stateNum) === 3) {
          this.makeNodeGrayFun(event.data.data);
        }
      } else if (event.data.type === 'toShowSelect') {
        let data = Utils.copy(Model.define);
        let mapData = Object.values(data.elements);
        this.branchList = [];
        for (let i = 0, length = mapData.length; i < length; i++) {
          if (mapData[i].name === 'linker' && mapData[i].from.id === this.showTaskItemId) {
            console.log(mapData[i], 'mapData');
            this.branchList.push(mapData[i]);
          }
        }
        this.showBox = true;
      } else if (event.data.type === 'changeStateOver') {
        if (this.memoryState != -1) this.flowItemInfo.taskState = this.memoryState;
        if (Number(this.stateNum) === 3) {
          this.makeNodeGrayFun(event.data.data);
        }
      } else if (event.data.type === 'checkItem') {
        Utils.selectShape(event.data.iframeMessage);
      }
    },
    toHint() {
      if (!this.isUpdate) {
    ...
    submitPoint() {
      let branchTags = '';
      this.branchSelect.forEach((index) => {
        branchTags += this.branchList[index].branchNum + ',';
      });
      branchTags = branchTags.substring(0, branchTags.length - 1);
      window.parent.postMessage(
        {
          iframeMessage: branchTags,
          flowId: this.showTaskItemId,
          type: 'submitPoint',
          index: this.$route.query?.index,
        },
        '*',
    ...
    selectBranch(index) {
      if (this.branchSelect.indexOf(index) !== -1) {
        this.branchSelect.splice(this.branchSelect.indexOf(index), 1);
      } else {
        this.branchSelect.push(index);
      }
    },
    tostopclick(e) {
    ...
    //导入页面数据
    importInfo() {
      this.$axios.get('/json/testImportInfo2.json', {}).then((response) => {
        console.log(response);
        this.todoInfo(response.data);
    ...
    todoInfo(data) {
      const info = Object.values(data.elements);
      const messageInfo = info.filter((item) => {
        return item.itemMessage != undefined;
      });
    ...
    exportInfo() {
      let data = Utils.copy(Model.define);
      console.log(JSON.stringify(data), 'exportInfo');
    },

    handleCommand(num) {
      if (this.flowItemInfo.taskState === 3) {
        this.$message.error('已完成任务无法修改');
        return;
      }
      let priProcessTaskId = null;
      let data = Utils.copy(Model.define);
      ...
      let mapData = Object.values(data.elements);
      for (let i = 0, length = mapData.length; i < length; i++) {
        if (mapData[i].name === 'linker' && mapData[i].to.id === this.selectFlowItemId) {
          priProcessTaskId = mapData[i].from.id;
        }
      }
      ...
      window.parent.postMessage(
        {
          iframeMessage:
            { priProcessTaskId: priProcessTaskId, processTaskId: this.selectFlowItemId, taskState: num } || '',
          type: 'toChangeState',
          index: this.$route.query?.index,
        },
        '*',
      );
      // this.flowItemInfo.taskState = num;
      this.memoryState = num;
      // this.$message.info('切换状态可能过慢,请耐心等待')
    },
    ...
    sureAddTreeType(hostItem, executeItem, permissionItem) {
      console.log(hostItem, executeItem, permissionItem, 'dgsdfsdhgd');
      ...
      if (this.flowItemInfo.hostItem && this.flowItemInfo.hostItem.id)
        this.flowItemInfo.person = executeItem.length + 1;
      else this.flowItemInfo.person = executeItem.length;
    },
    cancelAddTreeType() {
      this.TreeBoxType = false;
    },
    ...
    clearLineColor() {
      const dataJSON = Utils.copy(Model.define);
      if (this.showTaskItem.lineColor && dataJSON) {
        const shapeObj = dataJSON.elements[this.showTaskItem?.id];
        // console.log(shapeObj, 'hhhhhhhhhhhhhhhhhhhhhhhhhhhhhh')
        if (shapeObj) {
          shapeObj.lineStyle.lineColor = this.showTaskItem.lineColor === '1' ? '' : this.showTaskItem.lineColor;
          Designer.open(dataJSON);
          Designer.initialize.initCanvas();
        }
      }
...
#designer_viewport >>> .shape_anchor {
  display: none !important;
}
#designer_viewport >>> .shape_locker {
  display: none !important;
}
